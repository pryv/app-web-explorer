                        ...
                        <b-card-text>
                            <b-card class="card-style shadow min-height-card">
                                ...
                                <div style="text-align: left">
                                    <b-button class="pryv-btn-collapse" v-b-toggle.collapse-1 variant="primary">View
                                        Service Info
                                    </b-button>
                    ...
                    <b-tab title="Username, Password Login">
                        <b-card-text>
                            <b-card class="card-style shadow">
                                ...
                                <br>
                                <div style="text-align: left">
                                    <b-button class="pryv-btn-collapse" v-b-toggle="'collapse-2'" variant="primary">View
                                        Service Info
                                    </b-button>
